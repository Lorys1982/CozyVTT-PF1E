    ...
    <div className="grid gap-6 lg:grid-cols-2">
      <Panel title="Vitals" icon={Heart}>
        <div className="grid grid-cols-3 gap-3">
          <div className="rounded-xl bg-red-50 p-3 text-center"><div className="text-xs font-semibold uppercase text-red-700">HP</div><div className="text-3xl font-black text-red-900">{data.hp?.current??0}<span className="text-base text-red-700"> / {data.hp?.maximum??0}</span></div></div>
